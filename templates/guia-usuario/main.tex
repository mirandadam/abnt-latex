...
\begin{tabela}{Pacotes do projeto latex-abnt e normas correspondentes}
  ...
  \begin{tabelaabnt}{colspec={llp{6cm}}}
    ...
    \code{abnt-refs}      & NBR 6023:2018 & Referências bibliográficas \\
...
\begin{quadro}{Checklist --- redação e estilo}
  ...
  \begin{quadroabnt}{colspec={clX[l]}}
    ...
    2 & NBR 6028 \S4.1.8 &
      ...
      e 250 palavras. O \LaTeX{} não conta palavras automaticamente;
...
\begin{quadro}{Checklist --- elementos do documento}
  ...
  \begin{quadroabnt}{colspec={clX[l]}}
    ...
    8 & NBR 14724 \S4.2.1.9--12 &
      \textbf{Listas de ilustrações, tabelas, siglas e símbolos.}
...
\begin{quadro}{Checklist --- tabelas (IBGE)}
  ...
  \begin{quadroabnt}{colspec={clX[l]}}
    ...
    13 & IBGE &
      ...
      Tabelas longas que ocupam mais de uma página devem repetir
      o cabeçalho em cada página e indicar ``continua'' no topo
      e ``conclusão'' na última página. O ambiente \code{longtblr}
      do tabularray suporta esse caso, mas não está integrado ao
      ambiente \code{tabela} do pacote. \\
    14 & IBGE \S6.1b--6.3b &
...
\begin{quadro}{Checklist --- índice remissivo}
  ...
  \begin{quadroabnt}{colspec={clX[l]}}
    \# & Norma & Requisito \\
    17 & NBR 6034 \S6.8 &
      \textbf{Marca ``(continuação)'' em índices longos.}
      Quando o índice remissivo se estende por mais de uma página, cada
      página após a primeira deve trazer a indicação ``(continuação)''
      abaixo do título. Não implementado automaticamente. \\
    18 & NBR 6034 \S6.5 &
      \textbf{Letras iniciais no cabeçalho corrente do índice.}
      O cabeçalho corrente (\emph{running header}) de cada página do
      índice deve indicar a primeira e a última letra inicial presentes
      naquela página (ex.: ``C--F''). Não implementado. \\
  \end{quadroabnt}
\end{quadro}
...
\begin{quadro}{Checklist --- lombada}
  ...
  \begin{quadroabnt}{colspec={clX[l]}}
    ...
    23 & NBR 12225 \S4.1c &
      ...
      A norma prevê três disposições: descendente (texto de cima para
      baixo), horizontal (texto empilhado) e mista (combinação das
      duas). O pacote implementa as duas primeiras; a disposição mista
      não está disponível. \\
    24 & NBR 12225 \S4.3.3 &
